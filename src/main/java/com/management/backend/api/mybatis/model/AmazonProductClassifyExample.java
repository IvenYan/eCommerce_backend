...
public class AmazonProductClassifyExample {
    ...
    public AmazonProductClassifyExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andNodepathIn(List<String> values) {
            addCriterion("nodePath in", values, "nodepath");
            return (Criteria) this;
        }

        public Criteria andNodepathNotIn(List<String> values) {
            addCriterion("nodePath not in", values, "nodepath");
            return (Criteria) this;
        }
